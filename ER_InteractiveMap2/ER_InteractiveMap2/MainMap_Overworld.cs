...
namespace ER_InteractiveMap2
{
    public partial class MainMap_Overworld : Form
    {
        ...
        {
            this.LimgraveButton.Location = new Point(510, 700);      //v škole na crg: 512, 658           doma: 512, 700
            this.LimgraveButton.Size = new Size(450, 366);           //v škole na crg: 450, 358           doma: 450, 366
            this.LimgraveButton.ImageSize = new Size(450, 333);      //v škole na crg: 450; 335           doma: 450, 333
            ...
            this.CaelidButton.Location = new Point(894, 620);        //v škole na crg: 894, 558           doma: 894, 620
            this.CaelidButton.Size = new Size(449, 272);             //v škole na crg: 449                doma: 449, 272
            this.CaelidButton.ImageSize = new Size(433, 277);        //v škole na crg: 433                doma: 433, 277
            ...
            this.LiurniaButton.Location = new Point(194, 335);        //v škole na crg:                    doma: 
            this.LiurniaButton.Size = new Size(504, 500);             //v škole na crg:                    doma: 
            this.LiurniaButton.ImageSize = new Size(493, 435);        //v škole na crg:                    doma:                       
            ...
            this.VolcanoButton.Location = new Point(341, 268);        //v škole na crg:                    doma: 
            this.VolcanoButton.Size = new Size(274, 131);             //v škole na crg:                    doma: 
            this.VolcanoButton.ImageSize = new Size(250, 125);        //v škole na crg:                    doma:                       
            ...
            /*this.AltusButton.Location = new Point(513, 265);          //v škole na crg:                    doma: 
            this.AltusButton.Size = new Size(280, 202);               //v škole na crg:                    doma: 
            this.AltusButton.ImageSize = new Size(280, 187);          //v škole na crg:                    doma:                       
            ...
            this.AltusButton.MouseUp += ImaheButton_MouseUp;

            this.LeyndellButton.Location = new Point(666, 315);       //v škole na crg:                    doma: 
            this.LeyndellButton.Size = new Size(384, 172);            //v škole na crg:                    doma: 
            this.LeyndellButton.ImageSize = new Size(350, 160);       //v škole na crg:                    doma:                       
            ...
            this.LeyndellButton.MouseUp += ImaheButton_MouseUp;

            this.MountaintopsButton.Location = new Point(934, 160);   //v škole na crg:                    doma: 
            this.MountaintopsButton.Size = new Size(520, 312);        //v škole na crg:                    doma: 
            this.MountaintopsButton.ImageSize = new Size(545, 300);   //v škole na crg:                    doma:                       
            ...
            this.MountaintopsButton.MouseUp += ImaheButton_MouseUp;

            this.MiquellaButton.Location = new Point(1000, 42);       //v škole na crg:                    doma: 
            this.MiquellaButton.Size = new Size(228, 124);            //v škole na crg:                    doma: 
            this.MiquellaButton.ImageSize = new Size(222, 125);       //v škole na crg:                    doma:                       
            ...
            this.MiquellaButton.MouseUp += ImaheButton_MouseUp;

            this.AzulaButton.Location = new Point(1560, 473);         //v škole na crg:                    doma: 
            this.AzulaButton.Size = new Size(235, 110);               //v škole na crg:                    doma: 
            this.AzulaButton.ImageSize = new Size(216, 110);          //v škole na crg:                    doma:                       
            ...
            this.AzulaButton.MouseUp += ImaheButton_MouseUp;

            this.UndergroundButton.Location = new Point(1721, 892);
        ...
        private void CaelidButton_MouseDown(object sender, MouseEventArgs e)
        {
